...
codex_hooks deprecation - [Agent integration](pages/agent-integration.md)
...
Trapperkeeper worktree - [Agent integration](pages/agent-integration.md)
trk prime - [Agent integration](pages/agent-integration.md)
